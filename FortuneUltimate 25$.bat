...
curl -g -k -L -# -o "C:\FortunePremium\nvidiaProfileInspector.zip" "https://github.com/Orbmu2k/nvidiaProfileInspector/releases/latest/download/nvidiaProfileInspector.zip"
cls
powershell -NoProfile Expand-Archive '%temp%\nvidiaProfileInspector.zip' -DestinationPath 'C:\FortunePremium\'
cls 
%b%
...
echo.                            %b%╚═╝  ╚═╝╚══════╝╚═════╝    ╚═╝    ╚════╝ ╚═╝  ╚═╝╚══════╝  ╚═╝      ╚════╝ ╚═╝╚═╝  ╚══╝   ╚═╝
echo.
echo.                                                      %b%Do you want to Create a Restore Point?
echo.
echo.                                                    %b%[1] Make A restore Point      %b%[2] Skip 
echo. 
echo.                                                       
echo.
...
:rON
chcp 437 >nul 
powershell -ExecutionPolicy Bypass -Command "Checkpoint-Computer -Description 'FortunePremium' -RestorePointType 'MODIFY_SETTINGS'" 
chcp 65001 >nul 
echo.
echo.
echo.
...
cls
echo.
echo.     %b%Downloading resources...
echo.
curl -g -k -L -# -o"C:\FortunePremium\Exm_Free_Settings_V3.nip" "https://cdn.discordapp.com/attachments/1116671831961763860/1176986656625135626/Exm_Free_Settings_V3.nip?ex=6570dd3e&is=655e683e&hm=c22497d247c7f020ba1cdcbb93e9cdfce83a20aa69dec8e87b3c864506c8ccc0&" 
...
echo.     %b%Downloading resources...
echo.
curl -g -k -L -# -o"C:\FortunePremium\autoruns.exe" "https://cdn.discordapp.com/attachments/1116671831961763860/1176986656981663874/autoruns.exe?ex=6570dd3e&is=655e683e&hm=73215f3af01d22a3bd3f9de9b6e8534de127e9b14e3d1bb21b807b46bf31d59c&"
timeout /t 1 /nobreak > NUL
...
echo.     %b%Downloading resources...
echo.
curl -g -k -L -# -o"C:\FortunePremium\Update_Blocker.exe" "https://cdn.discordapp.com/attachments/1116671831961763860/1176986659288526968/Update_Blocker.exe?ex=6570dd3e&is=655e683e&hm=a358835d772590c582239d56861f69b3bcf6077b7740a1d21c904242783ba9da&"
timeout /t 1 /nobreak > NUL
...
echo.     %b%Downloading resources...
echo.
curl -g -k -L -# -o"C:\FortunePremium\DeviceCleanup.exe" "https://cdn.discordapp.com/attachments/1116671831961763860/1176986655492673716/DeviceCleanup.exe?ex=6570dd3e&is=655e683e&hm=d741c2eac0b808b039ebe8774ef997a1ec490d51d7770ec603426275ceb714a5&"
timeout /t 1 /nobreak > NUL
...
echo.
echo.                                                                                                                                              
echo.                                     %b%[1]%w% Network Tweaks                  %b%[2]%w% Power Tweaks               %b%[3]%w% Registry Tweaks                          
echo.
echo.                                     %b%[4]%w% General Tweaks                  %b%[5]%w% Windows Tweaks             %b%[6]%w% Prioirty Tweaks       
echo.                                                                                                                                                                                                                                                                                                                                        
echo.                                     %b%[7]%w% Clean PC                        %b%[8]%w% Autorun Apps               %b%[9]%w% MMCSS                                    
echo.                                                                                                                                              
echo.                                     %b%[10]%w% Nvidia Gpu Tweaks              %b%[11]%w% Amd Gpu Tweaks            %b%[12]%w% Gpu Tweaks                                  
echo.                                                                                                                                              
echo.                                     %b%[13]%w% Ram Tweaks                     %b%[14]%w% Cpu Tweaks                %b%[15]%w% Storage                              
echo.                                                                                                                                              
echo.                                     %b%[16]%w% Disable Telemetry              %b%[17]%w% Usb Tweaks                %b%[18]%w% Device Cleanup                      
echo.                                                                                                                                              
echo.                                     %b%[19]%w% Bios Tweaks                    %b%[20]%w% Mouse and Keyboard        %b%[21]%w% Mitigations                                   
echo.                                                                                                                                              
echo.                                     %b%[22]%w% Disable Useless Animations     %b%[23]%w% Windows Update Blocker    %b%[24]%w% Latency Tweaks   
echo.
echo.                                     %b%[25]%w% BCDedit                        %b%[26]%w% DirectX Tweaks            %b%[27]%w% Debloat 
echo.
echo.                                     %b%[28]%w% Custom Power Plan              %b%[29]%w% Optimize Games            %b%[30]%w% Fortnite Real Ping                        
echo.                                                                                                                                                
echo.                                                                                                                                                 
echo.                                                  %b%[D]%w% Revert 			                       %b%[W]%w% Fortune Web                                                  
echo.                                                                                                                                              
echo.                                                  %b%[R]%w% Use Restore Point                        %b%[E]%w% Exit                                       
echo.                                                                                                                                              
echo.                                                                                  %g%Version 1.00                                                                       
echo.                                                                                                                                                      
echo.                                                                 %b%Made by FortuneTeam // @FortuneTweaks on twitter                             
echo.                                                                                                                                              


set /p input=:
if /i %input% == 1 goto netmenu
if /i %input% == 2 goto 2
if /i %input% == 3 goto 3
if /i %input% == 4 goto 4
if /i %input% == 5 goto 5
...
if /i %input% == D goto :e
if /i %input% == W goto start https://payhip.com/FortuneTweaks
...
echo.
echo.
echo.                                               If you want to use settings to revert without using restore point 
echo.
echo.                                                              %b%[1] Bring back default power plans
echo.
echo.                                                              %b%[2] Reinstall default windows apps
echo.
echo.                                                                      %b%[M] Back to menu
...
:r1
PowershellCommand "GeAppxPackageallusers | foreach {AdAppxPackageregister “$($_.InstallLocation)\appxmanifest.xml”DisableDevelopmentMode}"
echo.
echo.                                                                   Operation Completed, Press any key to continue
echo.                                         
pause > nul
...
echo. 
echo.  
echo.                               %b%[1]%w% Optimize Network Settings             %b%[2]%w% Turn Off limiting            %b%[3]%w% Registry Tweaks For Internet 
echo.
echo.                               %b%[4]%w% DNS Priority		                 %b%[5]%w% Enable Onboard Processor     %b%[6]%w% Enable Direct Cache Access
echo.
echo.                               %b%[7]%w% Disable Nagiles Algorithm             %b%[8]%w% Disable WIFI                 %b%[9]%w% Enable MSI Mode On network adapter
echo.
echo.                               %b%[10]%w% Network Throttling Index             %b%[11]%w% Network Adapter Priority    %b%[12]%w% Optimize Lan Server
echo.
echo.
echo. 																			     	%b%[0]%w% Fully Reset Network Settings
echo.
echo.
...
:1
set /p input=:
if /i %input% == 1 goto netsettings
if /i %input% == 2 goto limit
if /i %input% == 3 goto netreg
if /i %input% == 4 goto dnsprio
if /i %input% == 5 goto onboard
if /i %input% == 6 goto dirl
if /i %input% == 7 goto nigel
if /i %input% == 8 goto wifi
if /i %input% == 9 goto nmsi
if /i %input% == 10 goto NetworkThrottlingIndex
if /i %input% == 11 goto n14
if /i %input% == 12 goto n13
...
echo.
echo.                                              
echo.                                              %b%Operation Completed, Press any key to continue.
echo. 
pause > nul
cls
goto :net
...
echo Optimizing Network Throttling Index
...
cls
:: Msi Mode
echo Enabling MSI Mode On Network Adapter
...
cls
echo.
echo.                                               			 You Want To Disable Wifi Services?
echo.
echo.                                           %b%[1] Disable Wifi Services             %b%[R] Enable Wifi (Revert)
echo.
echo.
...
:dnsprio
cls
:: Setting Dns Priority
echo Dns Priority Settings
...
:onboard
cls
:: Enabling OnBoard Processor
echo Enabling Onboard Processor
...
:: PowerSaving Disable
echo Disabling PowerSaving Options
Reg.exe add "%%n" /v "AutoPowerSaveModeEnabled" /t REG_SZ /d "0" /f 
Reg.exe add "%%n" /v "AutoDisableGigabit" /t REG_SZ /d "0" /f 
Reg.exe add "%%n" /v "AdvancedEEE" /t REG_SZ /d "0" /f 
Reg.exe add "%%n" /v "DisableDelayedPowerUp" /t REG_SZ /d "2" /f 
...
:: Energy Estimation Use
echo Disabling Telemetry Energy
...
:: Processor Settings
echo Important Processor Settings
...
:: Maximum Power Tweaks
echo Enabling Highest Performance Settings
...
:: Enable Idle Power Managment
echo Enabling Idle Power Management
...
:: Hidden power plan settings
echo Applying Hidden Power Plan Settings
Reg.exe add "HKLM\SYSTEM\CurrentControlSet\Control\Power\PowerSettings\19cbb8fa_5279_450e_9fac_8a3d5fedd0c1\12bbebe6_58d6_4636_95bb_3217ef867c1a" /v "Attributes" /t REG_DWORD /d "2" /f
Reg.exe add "HKLM\SYSTEM\CurrentControlSet\Control\Power\PowerSettings\245d8541_3943_4422_b025_13a784f679b7" /v "Attributes" /t REG_DWORD /d "2" /f
Reg.exe add "HKLM\SYSTEM\CurrentControlSet\Control\Power\PowerSettings\2a737441_1930_4402_8d77_b2bebba308a3\0853a681_27c8_4100_a2fd_82013e970683" /v "Attributes" /t REG_DWORD /d "2" /f
Reg.exe add "HKLM\SYSTEM\CurrentControlSet\Control\Power\PowerSettings\2a737441_1930_4402_8d77_b2bebba308a3\48e6b7a6_50f5_4782_a5d4_53bb8f07e226" /v "Attributes" /t REG_DWORD /d "2" /f
...
:: Setting All Logical Processors
echo Setting All Logical Processors to use
...
:: High P states and Low C states
echo Use Higher P-States on Lower C-States
...
:: Processor Tweaks
echo Ultimate Processor Tweaks
...
echo Enable Prefetch And Superfetch
...
:: Time to kill background apps
echo Time To Kill Background Apps
...
:: Processor Tweaks
echo Processor Registry Tweaks
...
Reg.exe add "HKLM\SYSTEM\CurrentControlSet\Control\Lsa\Credssp" /v "DebugLogLevel" /t REG_DWORD /d "0" /fReg.exe add "HKLM\SYSTEM\CurrentControlSet\Control\WMI\Autologger\AppModel" /v "Start" /t REG_DWORD /d "0" /f
Reg.exe add "HKLM\SYSTEM\CurrentControlSet\Control\WMI\Autologger\Cellcore" /v "Start" /t REG_DWORD /d "0" /f
Reg.exe add "HKLM\SYSTEM\CurrentControlSet\Control\WMI\Autologger\Circular Kernel Context Logger" /v "Start" /t REG_DWORD /d "0" /f
Reg.exe add "HKLM\SYSTEM\CurrentControlSet\Control\WMI\Autologger\CloudExperienceHostOobe" /v "Start" /t REG_DWORD /d "0" /f
Reg.exe add "HKLM\SYSTEM\CurrentControlSet\Control\WMI\Autologger\DataMarket" /v "Start" /t REG_DWORD /d "0" /f
...
Reg.exe add "HKLM\System\CurrentControlSet\Control\Lsa" /v "RestrictAnonymous" /t REG_DWORD /d "1" /f
Reg.exe add "HKLM\System\CurrentControlSet\Services\LanManServer\Parameters" /v "RestrictNullSessAccess" /t REG_DWORD /d "1" /f
Reg.exe add "HKLM\System\CurrentControlSet\Services\LanManServer\Parameters" /v "DisableCompression" /t REG_DWORD /d "1" /fReg.exe add "HKLM\SOFTWARE\Policies\Microsoft\PCHealth\ErrorReporting\DW" /v "DWNoSecondLevelCollection" /t REG_DWORD /d 1 /f
...
Reg.exe add "HKLM\Software\Policies\Microsoft\Windows\Windows Search" /v "ConnectedSearchUseWebOverMeteredConnections" /t REG_DWORD /d "0" /f
Reg.exe add "HKLM\Software\Policies\Microsoft\Windows\Windows Search" /v "DisableWebSearch" /t REG_DWORD /d "1" /f
Reg.exe add "HKLM\Software\Policies\Microsoft\Windows\Windows Search" /v "DoNotUseWebResults" /t REG_DWORD /d "1" /ffsutil behavior set memoryusage 2
timeout /t 1 /nobreak > nul
...
echo Disabling Notifications and Popups
...
reg add "HKCU\SOFTWARE\Microsoft\Windows\CurrentVersion\ContentDeliveryManager" /v "SubscribedConten338388Enabled" /t REG_DWORD /d "0" /f  
reg add "HKCU\SOFTWARE\Microsoft\Windows\CurrentVersion\ContentDeliveryManager" /v "SubscribedConten314559Enabled" /t REG_DWORD /d "0" /f  
reg add "HKCU\SOFTWARE\Microsoft\Windows\CurrentVersion\ContentDeliveryManager" /v "SubscribedConten280815Enabled" /t REG_DWORD /d "0" /f  
reg add "HKCU\SOFTWARE\Microsoft\Windows\CurrentVersion\ContentDeliveryManager" /v "SubscribedConten314563Enabled" /t REG_DWORD /d "0" /f  
reg add "HKCU\SOFTWARE\Microsoft\Windows\CurrentVersion\ContentDeliveryManager" /v "SubscribedConten338393Enabled" /t REG_DWORD /d "0" /f  
reg add "HKCU\SOFTWARE\Microsoft\Windows\CurrentVersion\ContentDeliveryManager" /v "SubscribedConten353694Enabled" /t REG_DWORD /d "0" /f  
reg add "HKCU\SOFTWARE\Microsoft\Windows\CurrentVersion\ContentDeliveryManager" /v "SubscribedConten353696Enabled" /t REG_DWORD /d "0" /f  
reg add "HKCU\SOFTWARE\Microsoft\Windows\CurrentVersion\ContentDeliveryManager" /v "SubscribedConten310093Enabled" /t REG_DWORD /d "0" /f  
reg add "HKCU\SOFTWARE\Microsoft\Windows\CurrentVersion\ContentDeliveryManager" /v "SubscribedConten202914Enabled" /t REG_DWORD /d "0" /f  
reg add "HKCU\SOFTWARE\Microsoft\Windows\CurrentVersion\ContentDeliveryManager" /v "SubscribedConten338387Enabled" /t REG_DWORD /d "0" /f  
reg add "HKCU\SOFTWARE\Microsoft\Windows\CurrentVersion\ContentDeliveryManager" /v "SubscribedConten338389Enabled" /t REG_DWORD /d "0" /f  
reg add "HKCU\SOFTWARE\Microsoft\Windows\CurrentVersion\ContentDeliveryManager" /v "SubscribedConten353698Enabled" /t REG_DWORD /d "0" /f  
...
reg add "HKLM\SOFTWARE\Policies\Microsoft\Windows Defender\ReaTime Protection" /v "DisableBehaviorMonitoring" /t REG_DWORD /d "1" /f  
reg add "HKLM\SOFTWARE\Policies\Microsoft\Windows Defender\ReaTime Protection" /v "DisableIOAVProtection" /t REG_DWORD /d "1" /f  
reg add "HKLM\SOFTWARE\Policies\Microsoft\Windows Defender\ReaTime Protection" /v "DisableOnAccessProtection" /t REG_DWORD /d "1" /f  
reg add "HKLM\SOFTWARE\Policies\Microsoft\Windows Defender\ReaTime Protection" /v "DisableRealtimeMonitoring" /t REG_DWORD /d "1" /f  
...
:: Fortnite Hidden Settings
echo Applying Fortnite Hidden Settings
...
Reg.exe add "HKLM\SOFTWARE\Microsoft\Windows NT\CurrentVersion\Multimedia\SystemProfile\Tasks\Low Latency" /v "Latency Sensitive" /t REG_SZ /d "True" /fReg.exe add "HKLM\SOFTWARE\Microsoft\Windows NT\CurrentVersion\Multimedia\SystemProfile\Tasks\Games" /v "Affinity" /t REG_DWORD /d "0" /f
...
Reg.exe add "HKLM\SOFTWARE\Microsoft\Windows NT\CurrentVersion\Multimedia\SystemProfile\Tasks\Games" /v "Scheduling Category" /t REG_SZ /d "High" /f
Reg.exe add "HKLM\SOFTWARE\Microsoft\Windows NT\CurrentVersion\Multimedia\SystemProfile\Tasks\Games" /v "SFIO Priority" /t REG_SZ /d "High" /f
Reg.exe add "HKLM\SOFTWARE\Microsoft\Windows NT\CurrentVersion\Multimedia\SystemProfile\Tasks\Games" /v "Latency Sensitive" /t REG_SZ /d "True" /fReg.exe add "HKLM\SOFTWARE\Microsoft\Windows NT\CurrentVersion\Multimedia\SystemProfile\Tasks\Window Manager" /v "Background Only" /t REG_SZ /d "True" /f
...
Reg.exe add "HKLM\SOFTWARE\Microsoft\Windows NT\CurrentVersion\Multimedia\SystemProfile\Tasks\Window Manager" /v "SFIO Priority" /t REG_SZ /d "Normal" /fReg.exe add "HKLM\SOFTWARE\Microsoft\Windows NT\CurrentVersion\Image File Execution Options\csrss.exe\PerfOptions" /v "CpuPriorityClass" /t REG_DWORD /d "4" /f
...
Reg.exe add "HKLM\SYSTEM\ControlSet001\Control\PriorityControl" /v "IRQ8Priority" /t REG_DWORD /d "1" /fReg.exe add "HKLM\SYSTEM\CurrentControlSet\Control\PriorityControl" /v "IRQ16Priority" /t REG_DWORD /d "2" /f
Reg.exe add "HKLM\SYSTEM\ControlSet001\Control\PriorityControl" /v "IRQ16Priority" /t REG_DWORD /d "2" /fReg.exe add "HKLM\SOFTWARE\Microsoft\Windows NT\CurrentVersion\Image File Execution Options\svchost.exe\PerfOptions" /v "CpuPriorityClass" /t REG_DWORD /d "1" /f
Reg.exe add "HKLM\SOFTWARE\Microsoft\Windows NT\CurrentVersion\Image File Execution Options\svchost.exe\PerfOptions" /v "IoPriority" /t REG_DWORD /d "0" /fReg.exe add "HKLM\SYSTEM\CurrentControlSet\Services\DXGKrnl\Parameters" /v "ThreadPriority" /t REG_DWORD /d "15" /f
Reg.exe add "HKLM\SYSTEM\CurrentControlSet\Services\nvlddmkm\Parameters" /v "ThreadPriority" /t REG_DWORD /d "15" /fReg.exe add "HKLM\SOFTWARE\Microsoft\Windows NT\CurrentVersion\Multimedia\SystemProfile" /v "SystemResponsiveness" /t REG_DWORD /d "0" /f
timeout /t 1 /nobreak > NUL
echo.
echo.
echo.
...
powershell -Command "& {Add-Type -AssemblyName System.Windows.Forms; [System.Windows.Forms.MessageBox]::Show('After you press ok it will open an app, Go to the LOGON section, disable all services except: antivirus, cmd.exe, and the n/a services', 'Fortune Premium', 'Ok', [System.Windows.Forms.MessageBoxIcon]::Information);}"
chcp 65001 > nul

start C:\FortunePremium\autoruns.exe
...
start "NvidiaProfileInspector.exe" /wait "C:\FortunePremium\NvidiaProfileInspector.exe" 
...
Reg delete "HKLM\SOFTWARE\Policies\Microsoft\Windows\Display" /v "EnableGdiDPIScaling" /f
...
Reg delete "%%a" /v "RMHdcpKeyglobZero" /f
echo Enable HDCP
...
if "%pstates%" equ "0x0" (Reg delete "%%a" /v "DisableDynamicPstate" /f)
...
Reg delete "%%a" /v "PowerMizerEnable" /f
Reg delete "%%a" /v "PowerMizerLevel" /f
Reg delete "%%a" /v "PowerMizerLevelAC" /f 	
Reg delete "%%a" /v "PerfLevelSrc" /f
)
)
...
if %errorlevel% neq 0 wmic pagefileset where name="C:\\pagefile.sys" set InitialSize=16384,MaximumSize=16384
if %errorlevel% neq 0 wmic pagefileset where name="C:\\pagefile.sys" set InitialSize=8192,MaximumSize=8192
if %errorlevel% neq 0 wmic pagefileset where name="C:\\pagefile.sys" set InitialSize=4096,MaximumSize=4096
if %errorlevel% neq 0 wmic pagefileset where name="C:\\pagefile.sys" set InitialSize=2048,MaximumSize=2048
if %errorlevel% neq 0 wmic pagefileset where name="C:\\pagefile.sys" set InitialSize=1024,MaximumSize=1024
...
powercfg -setacvalueindex scheme_current sub_processor PERFBOOSTMODE 1
powercfg -setacvalueindex scheme_current sub_processor PERFBOOSTPOL 100
if "%honepow%" neq "0x1" powercfg -changename scheme_current "%EchoXPowName%" "For EchoX Optimizer %Version% (dsc.gg/EchoX) By UnLovedCookie"
powercfg -setactive scheme_current
echo Disable Throttle States
powercfg -setacvalueindex scheme_current sub_processor THROTTLING 0
Reg.exe add "HKLM\SYSTEM\CurrentControlSet\Control\Power\PowerSettings\54533251-82be-4824-96c1-47b60b740d00\0cc5b647-c1df-4637-891a-dec35c318583" /v "ValueMin" /t REG_DWORD /d "0" /f
...
:18
cls
start C:\FortunePremium\DeviceCleanup.exe
echo.
echo.
echo.
echo.                                              
...
echo                  [96mBIOS Optimizations%col1%

if "%Res%" equ "0x1" (
::Timer Resolution
%windir%\Microsoft.NET\Framework\v4.0.30319\InstallUtil.exe /i %systemdrive%\EchoRes.exe
...
sc stop STR1
if exist "%tmp%\EchoView.exe" ("%tmp%\EchoView.exe" /disable "High Precision Event Timer")
bcdedit /deletevalue useplatformclock
bcdedit /set disabledynamictick yes
echo Disable HPET
)
...
::Quick Boot
if "%duelboot%" equ "yes" (bcdedit /timeout 0)
...
echo.
echo.
echo.                                                          Chose CPU range you have
echo.                                         [1] High-End Cpu      [2] Mid-End Cpu     [3] Low-End Cpu
echo.
echo.
echo.                                                         [R] If you want to revert settings
echo.
echo.                                                         [X] If you want to go back
echo.
...
rem for /f "tokens=1" %%i in ('driverquery') do Reg add "HKLM\System\CurrentControlSet\Services\%%i\Parameters" /v "DmaRemappingCompatible" /t REG_DWORD /d "0" /f
...
powershell -Command "& {Add-Type -AssemblyName System.Windows.Forms; [System.Windows.Forms.MessageBox]::Show('Select disable updates in wub, press ok to open it', 'FortunePremium', 'Ok', [System.Windows.Forms.MessageBoxIcon]::Information);}"
chcp 65001 > nul

start C:\FortunePremium\Update_Blocker.exe
echo.
echo.
echo.                                              
echo.                                              %b%Operation Completed, Press any key to continue.
...
echo USB MSI Mode
echo USB Affinites
echo Delete all device prioritiess
...
echo.
echo.
echo.                                                Debloat your pc, with removing startup apps and other unuseful stuff
echo.
echo.                                           %b%[1] %w%Disable Startup Apps       %b%[2] %w%Disable Useless Services
echo.
echo.                                           %b%[3] %w%Debloat Google Chrome      %b%[4] %w%Uninstall Useless Preinstalled Apps
echo.
echo.                                                        %b%[5] %w%Disable Unneccesarry bloatware
echo.
echo.
echo.
...
set /p input=:
if /i %input% == 1 goto startapps
if /i %input% == 3 goto google
if /i %input% == 2 goto services
if /i %input% == 4 goto wdebloat
if /i %input% == 5 goto bloat
if /i %input% == X cls & goto menu
...
echo.
echo.
echo.                                       APPLY HIGH PRIORITY TO SOME OF THESE GAMES!
echo.
echo.
echo.                                        %b%[1] %w%Fortnite           %b%[2] %w%GTA 5

set /p input=:
if /i %input% == 1 goto fn
if /i %input% == 2 goto gta5
if /i %input% == R goto revert
...
cls
echo.
echo.                                                   Find out how actualy ping do you have
echo.
echo.
echo.                                                  %b%[1] %w%Eu             %b%[2] %w%Me
echo.
echo.                                                  %b%[3] %w%NAC            %b%[4] %w%NAW
echo.
echo.                                                  %b%[5] %w%Bra            %b%[6] %w%Asia
echo.
echo.                                                  %b%[7] %w%NAE            %b%[8] %w%Oce
echo.
echo.
set /p input=:
if /i %input% == 1 goto eu
if /i %input% == 2 goto me
if /i %input% == 3 goto nac
if /i %input% == 4 goto naw
if /i %input% == 5 goto br
if /i %input% == 6 goto asia
if /i %input% == 7 goto nae
