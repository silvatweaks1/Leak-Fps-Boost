...
set CPU_NAME=%PROCESSOR_IDENTIFIER% > nul
...
POWERSHELL "Checkpoint-Computer -Description \"Exm Premium Tweaks\" -RestorePointType \"MODIFY_SETTINGS\""
...
echo. ════════════════════════════════════════
echo.
echo     %w% Making Folder For rescourses %b%
echo.
echo. ════════════════════════════════════════

@echo on
md C:\exm\PowerPlan
md C:\exm\NvidiaProfileInspector
md C:\exm\WindowsUpdateBlocker"
md C:\exm\FortniteSettings
md C:\exm\Autoruns
@echo off
...
echo. ═════════════════════════════
echo.
echo     %w% Downloading rescorses %b%
echo.
echo. ═════════════════════════════
echo.

echo Downloading Nvidia Profile Inspector
curl -g -k -L -# -o "C:\exm\NvidiaProfileInspector\Reference.xml" "https://cdn.discordapp.com/attachments/1129168931081428992/1161715145043607753/Reference.xml"
curl -g -k -L -# -o "C:\exm\NvidiaProfileInspector\nvidiaProfileInspector.exe" "https://cdn.discordapp.com/attachments/1129168931081428992/1161715144305426462/nvidiaProfileInspector.exe"
curl -g -k -L -# -o "C:\exm\NvidiaProfileInspector\nvidiaProfileInspector.exe.config" "https://cdn.discordapp.com/attachments/1129168931081428992/1161715144645169172/nvidiaProfileInspector.exe.config"
curl -g -k -L -# -o "C:\exm\NvidiaProfileInspector\exmnvpri.nv" "https://cdn.discordapp.com/attachments/1129168931081428992/1161715143978266835/exmnvpri.nv"
...
echo Downloading Nvidia Profile Inspector Profile
curl -g -k -L -# -o "C:\exm\NvidiaProfileInspector\EXM_Premium_NVPI_Proifle_V3.nip" "https://cdn.discordapp.com/attachments/1129168931081428992/1159794973105983528/EXM_Premium_NVPI_Proifle_V3.nip?"
cls 
echo.
echo. ═════════════════════════════
echo.
...
echo Downloading Exm Premium Power Plan
curl -g -k -L -# -o "C:\exm\PowerPlan\Exm_Premium_Plan_2.0_.pow" "https://cdn.discordapp.com/attachments/1129168931081428992/1159794898090868797/Exm_Premium_Plan_2.0_.pow"
timeout /t 1 /nobreak > NUL
...
echo Downloading Fortnite Settings.exe
curl -g -k -L -# -o "C:\exm\FortniteSettings\Fortnite_Settings.exe" "https://cdn.discordapp.com/attachments/1129168931081428992/1159795061479985152/Fortnite_Settings.exe"
timeout /t 1 /nobreak > NUL
...
echo Downloading Windows Update Blocker
curl -g -k -L -# -o "C:\exm\WindowsUpdateBlocker\Wub.exe" "https://cdn.discordapp.com/attachments/1129168931081428992/1159794949437526056/Wub.exe"
timeout /t 1 /nobreak > NUL
...
curl -g -k -L -# -o "C:\exm\Autoruns\autoruns.exe" "https://cdn.discordapp.com/attachments/1129168931081428992/1159794815697948692/autoruns.exe"
timeout /t 1 /nobreak > NUL
cls

IF EXIST "C:\exm\NvidiaProfileInspector\exmnvpri.nv" (
    goto menu
) ELSE (
echo.
echo.
...
echo.       %b%║══════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════║
echo.       %b%║%w%                                                                                                                                                  %b%║
echo.       %b%║%w%                                                         Updated 11th October  * Version 0.94                                                     %b%║
echo.       %b%║%w%                                                                                                                                                  %b%║
echo.       %b%║══════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════║
echo.       %b%║%w%                                                                                                                                                  %b%║
...
echo.       %b%║%w%                                                      %b%═══════════════════════════════════════                                                     %b%║
echo.       %b%║%w%                                                                                                                                                  %b%║
echo.       %b%║%w%                                   %p%%w%                            %p%[0]%w% Soft Restart PC                                                                %b%║
echo.       %b%║%w%                                                                                                                                                  %b%║
...
Reg.exe add "HKCU\SOFTWARE\Microsoft\Windows\CurrentVersion\CapabilityAccessManager\ConsentStore\cellularData\Microsoft.Win32WebViewHost_cw5n1h2txyewy" /v "Value" /t REG_SZ /d "Allow" /f 
...
Reg.exe add "HKCU\SOFTWARE\Microsoft\Windows\CurrentVersion\CapabilityAccessManager\ConsentStore\location\Microsoft.Win32WebViewHost_cw5n1h2txyewy" /v "Value" /t REG_SZ /d "Prompt" /f 
...
Reg.exe add "HKCU\SOFTWARE\Microsoft\Windows\CurrentVersion\CapabilityAccessManager\ConsentStore\userAccountInformation\Microsoft.AccountsControl_cw5n1h2txyewy" /v "Value" /t REG_SZ /d "Prompt" /f 
...
Reg.exe add "HKCU\SOFTWARE\Microsoft\Windows\CurrentVersion\CapabilityAccessManager\ConsentStore\webcam\Microsoft.Win32WebViewHost_cw5n1h2txyewy" /v "Value" /t REG_SZ /d "Allow" /f 
echo.
echo.
echo.
echo.                                              %b%╔═══════════════════════════════════════════════════════╗
...
echo
echo.
echo.                               %p%[1]%w% Fsutil Tweaks          %p%[2]%w% Defragment
echo.
echo.
echo.                                               Press "X" to go back to menu
echo.
...
powercfg -import "C:\exm\PowerPlan\Exm_Premium_Plan_2.0_.pow"
...
echo.  
echo.                               %p%[1]%w% Disable Hiiden Power Saving Features  %p%[2]%w% Turn off limiting             %p%[3]%w% Optimize Network Adapter 
echo.
...
echo.
echo.                               %p%[13]%w% Optimize Lanman Server               %p%[14]%w% Advanced Network Tweaks      %p%[15]%w% Network Adapter Core Priority    
echo.
echo.
echo.                                                                      Press "X" to go back to the menu
echo.
